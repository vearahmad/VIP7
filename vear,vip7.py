...
db    db d88888b  .d8b.  d8888b.    db    db d888888b d8888b. d88888D 
88    88 88'     d8' `8b 88  `8D    88    88   `88'   88  `8D VP  d8' 
Y8    8P 88ooooo 88ooo88 88oobY'    Y8    8P    88    88oodD'    d8'  
`8b  d8' 88~~~~~ 88~~~88 88`8b      `8b  d8'    88    88~~~     d8'   
 `8bd8'  88.     88   88 88 `88. db  `8bd8'    .88.   88       d8'    
   YP    Y88888P YP   YP 88   YD V8    YP    Y888888P 88      d8'     
                                  P                                   
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r (vear,vip7-ᴛᴇsᴛ) {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
